 ...
 * 
 * Egoli - function that controls all player activities within the egoli  maze
 * @date 2024-04-16
 */
...
void egoli()
{
    ...
    egoli_start: //Reference Point
    system("cls");
    printf("\n-------------------------------------------------------------------------------\n\n");
    printf("     The Egoli Republic, because of its small size is a brotherhood.\n");
    printf("  A society of rich, influential men known for its great gates,\n");
    printf("  serene environment and classy occupants. The brotherhood of egoli\n");
