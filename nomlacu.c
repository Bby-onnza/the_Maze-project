 ...
 * 
 * Nomlacu - function that controls all player activities within the nomlacu maze
 * 
 * @date 2024-04-16
 */
...
void nomlacu()
{
    ...
    nomlacu_start: //Reference Point
    system("cls");

    printf("\n -----------------------------------------------------------------------------\n\n");
    printf("    Nomlacu is supposedly a nation of independence, however their practices,\n");
    ...
    printf("    way of life but the emperor of Nomlacu  has gotten word of this and has  \n");
