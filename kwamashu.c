 ...
 * 
 * kwamashu - function that controls all player activities within the kwamashu maze
 * 
 * @date 2024-04-15
 */
...
void kwamashu()
{
    ...
    kwamashu_start: //Reference Point
    system("cls");

    printf("\n    ---------------------------------------------------------------------\n\n");
    printf("\tThe Kwamashu's castle is so magnificent and awesome! Everyone \n");
    printf("\tsuspects however that the great Kwamashu is involved in some \n");
    ...
    printf("\n\t Oh NO! The Kwamashu's guard has caught you on the restricted\n");
