 ...
 * 
 * Kwanikhwe - function that controls all player activities within the kwanikhwe maze
 * 
 * @date 2024-04-16
 */
...
void kwanikhwe()
{
    ...
    kwanikhwe_start: //Reference Point
    system("cls");
    printf("\n -----------------------------------------------------------------------------\n\n");
    printf("        In the kingdom of kwanikhwe, chaos, noise and pandemonium are normal \n");
...
*/
    ...
    kwanikhwe_point0();
    printf("--------------------------------------------------------------\n");
    printf("You are now within the kwanikhwe kingdom Cornfield.");
